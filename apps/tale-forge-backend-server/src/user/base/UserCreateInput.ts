...
class UserCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => TaleCoinTransactionCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => TaleCoinTransactionCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => TaleCoinTransactionCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => WriterCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => WriterCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => WriterCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
